// Copied from https://github.com/aws-amplify/amplify-ui/blob/main/packages/react/src/components/Geo/MapView/index.tsx because it doesn't work directly?
 ...
 * }
 */
const CustomMapView = forwardRef<MapRef, MapViewProps>(
...
CustomMapView.displayName = "MapView";
